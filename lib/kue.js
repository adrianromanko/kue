...
Queue.prototype.promote = function(ms, l) {
    ...
    this.promoter = setInterval(function() {
        client.sort(client.getKey('jobs:delayed'), 'by', client.getKey('job:*->delay'), 'get', '#', 'get', client.getKey('job:*->delay'), 'get', client.getKey('job:*->created_at'), 'get', client.getKey('job:*->failed_at'), 'limit', 0, limit, function(err, jobs) {
